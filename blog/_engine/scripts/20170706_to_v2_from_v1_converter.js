...
fs.readFileSync(V1_CONTENTS_PATH + number).toString().split('\n').forEach(function (_line) {
    ...
    line = line.replace('<pre class="prettyprint lang-cpp">', "###code.cpp");
    ...
    line = line.replace('<pre class="prettyprint lang-js">', "###code.js");
    line = line.replace('<pre class="prettyprint linenums lang-sh">', "###code.sh");
    line = line.replace('<pre class="prettyprint lang-sh">', "###code.sh");
