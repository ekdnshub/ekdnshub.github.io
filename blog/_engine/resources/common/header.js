var Header = (function(){
	...
	var gnb = `<div id="_gnb" class="text-right" style="font-size:0.8em; padding:1px; background-color:#259CE0;"><a style="color:white; text-decoration:none;" href="//www.jdm.kr">Home</a>│<a style="color:white; text-decoration:none;" href="//blog.jdm.kr">Blog</a>│<a style="color:white; text-decoration:none;" href="//jdm.kr/guest/">Guestbook</a>│<a style="color:white; text-decoration:none;" href="//jdm.kr/lab/">Lab</a>&nbsp;</div>`;
...
<div id="top_subject" class="jumbotron" style="margin-bottom:2em; padding:1em; background-color:#259CE0; filter:alpha(opacity=80); opacity:0.8; -moz-opacity:0.8; color:white; border-radius: 0;">
    ...
    <p style="font-size:0.75em;" class="text-center">{{ content }}</p>
</div>`;
